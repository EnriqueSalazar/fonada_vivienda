...
/**
 * This is the model class for table "op_viviendas_docs".
 *
 * The followings are the available columns in table 'op_viviendas_docs':
 * @property integer $id
 ...
 */
class OpViviendasDocs extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return OpViviendasDocs the static model class
	 */
